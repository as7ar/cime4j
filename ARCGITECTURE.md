...
graph TD
    ...
    subgraph Networking["Networking Layer"]
        CimeWebsocket -->|connects to| AWSSocket
    ...
    subgraph Events["Event System"]
        AWSSocket -->|raw JSON| CimeWebsocket
...
graph LR
    ...
    subgraph Networking
        CimeWebsocket -->|"wss://edge.ivschat..."| AWSSocket
        AWSSocket -->|"Raw JSON Frame"| CimeWebsocket
    end

    subgraph Parsing
        CimeWebsocket -->|"CimeMessage"| CimeUtils
        CimeUtils -->|"Typed Event"| Cime
    end

    subgraph Events
        Cime -->|"ChatEvent"| HandlerMap
        Cime -->|"DonationEvent"| HandlerMap
        Cime -->|"MissionEvent"| HandlerMap
    end

    subgraph User
        HandlerMap -->|"Callback"| UserCode[("User Logic")]
    end
```
